...
class MatchMaker {
    ...
    awaitRoomAvailable(roomToJoin) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (concurrency > 0) {
                Debug_1.debugMatchMaking('receiving %d concurrent requests for joining \'%s\'', concurrency, roomToJoin);
                return yield new Promise((resolve, reject) => setTimeout(resolve, concurrency * 10));
            }
            else {
                return true;
            }
